        ...
        <div ref={emblaRef} className="overflow-hidden rounded-lg ">
          <div className="-ml-4 flex">
            {images?.map((image, index) => (
              <div
                key={index}
                className="min-w-0 max-h-[500px]  aspect-square shrink-0 grow-0 basis-full pl-4"
                role="group"
              ...
              >
                <Image
                  src={image.url}
                  alt={`Slide ${index + 1}`}
                  width={500} // set width to make it square
                  height={500} // set height to match width
                  className="object-contain" // use object-contain for containing the image
